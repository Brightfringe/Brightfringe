...
- 📡 Mesh gossip propagation with bridge node sync
- ⏱️ TTL-based packet forwarding with zero duplicate settlements
- 🏗️ 8 REST endpoints across a clean 3-layer architecture
- 💾 JPA / Hibernate + H2 persistence
